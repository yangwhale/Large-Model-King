...
| 真名 | 道号 | 门派 | 境界 | 简介 |
|------|------|------|------|------|
| 梁文锋 | 深渊剑主 | 幻方/DeepSeek 魔宗 | 大乘期 | 量化基金出身。带着交易系统的工程纪律做 AI。V2 的 MLA、V3 的 MoE+FP8、R1 的 GRPO。每次出手都改变规则。 |
| 杨植麟 | 月影侯 | 月之暗面/Kimi | 化神期 | 清华出身。Kimi 长上下文。K1.5 推理模型。K2 万亿参数 MoE。低调但野心大。 |
| 面壁智能 | 小丹王 | 面壁 | 金丹期 | MiniCPM。证明小模型也能修炼到高境界。WSD 学习率调度。 |
