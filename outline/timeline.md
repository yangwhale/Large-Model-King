...
**关键法器**: GTX TITAN → Tesla K80 → P100（灵核品阶跃升）
...
**灵核危机**: GPU 供不应求。A100 价格飞涨。算力成为修炼最大瓶颈。
...
- 2024-02：OpenAI 发布 Sora。文字生成视频。生成的视频逼真到让好莱坞恐慌。幻像兽从图片进化到了视频。
- 2024-03：Anthropic 发布 Claude 3 家族——Opus（最强）、Sonnet（均衡）、Haiku（最快）。三档定价，三种神兽。Claude 3 Opus 首次在多项测试中超越 GPT-4。
- 2024-04：Meta 发布 Llama 3。8B 版本用了 15T token 训练——远超 Chinchilla 最优比例（过度喂养小兽卵，反而炼出了超越体型的灵智）。
- 2024-05：GPT-4o 发布。"o"代表"omni"（全知）。文本、图片、语音原生多模态。能听、能看、能说——万象兽的雏形。
- 2024-06：Claude 3.5 Sonnet。性能超越 Claude 3 Opus，但成本只有五分之一。小兽卵炼出大灵智，开始动摇"越大越强"的信条。
- 2024-09：**OpenAI o1 发布**。神兽第一次学会了"思考"——在回答前用隐藏的思维链推理。数学和编程能力暴涨。修仙界称之为"思道觉醒"。
- 2024-09：HybridFlow/veRL 论文发布。生广明（炼器宗师）设计了 RL 训练的高效灵坛框架。
- 2024-10：Claude Computer Use 发布。神兽第一次学会了操控人类的法器（电脑）——能移动鼠标、点击按钮、浏览网页。从"回答问题"到"独立干活"的跨越。
- 2024-12：**DeepSeek V3 发布**。671B MoE。MLA + MTP + FP8 微缩锻造。2.788M H800 GPU hours。训练成本只有 GPT-4 的零头。
- 2024-12：OpenAI o3 发布。o1 的升级版。在 ARC-AGI 测试上首次达到人类水平得分。
- 2025-01：**DeepSeek R1 发布**。用 GRPO（群兽竞逐法）代替 PPO。纯 RL 训出推理能力。美股芯片股暴跌——华尔街没想到中国能用这么少灵石训出这么强的神兽。震动全球。
- 2025-01：**星际之门（Stargate）计划公布**。OpenAI + SoftBank + Oracle 宣布 5000 亿美元 AI 基础设施投资计划。修仙界有史以来最大的灵坛建设计划。
- 2025-08：**GPT-5 发布**。OpenAI 的新一代旗舰神兽。在编程、数学、写作上全面超越前代。
