...
📖 **相关章节**
- 想了解 PPO 四象阵的完整原理 → [第15章·四象驯兽](ch15-ppo-rlhf.md)
- 想了解 DPO 如何开启简化之路 → [第16章·直觉驯化](ch16-dpo.md)
- 想了解 GRPO + DAPO 的实战效果 → [第17章·群兽竞逐](ch17-grpo.md)
- 想了解 veRL 如何让这些方法都能高效运行 → [第19章·万法归一](ch19-verl.md)
