...
就像 Soumith Chintala（阵基铸师）没有发明反向传播，但他铸造了 PyTorch——让所有人都能用反向传播的阵基。
...
2026 年，生广明加入腾讯混元，担任 RL Infra 负责人。

腾讯混元此时的掌舵者是姚顺雨（思维树真人）——清华姚班出身，Tree of Thought 和 ReAct 的创造者，Agent 研究的先驱。2025 年底出任腾讯首席 AI 科学家。

这是一个有趣的组合：姚顺雨修法术（思维推理、Agent 架构），生广明修法器（训练系统、分布式基础设施）。法术宗师 + 阵基宗师，联手打造腾讯的下一代 AI。
...
>
> 2026 年他在腾讯混元跟姚顺雨会合。一个写 ReAct 和 Tree of Thought，一个写 veRL 和 Laminar。法术 + 法器。如果腾讯能把这两个人的能力乘在一起而不是加在一起，混元的 RL 训练栈会非常可怕。
>
...
- 想了解 DPO 如何简化了驯兽过程 → [第16章·直觉驯化](ch16-dpo.md)
- 想了解 GRPO 和 DeepSeek R1 的故事 → [第17章·群兽竞逐](ch17-grpo.md)
- 想了解 DAPO/KTO/SimPO 百花齐放 → [第18章·诸法争鸣](ch18-variants.md)
- 想了解梁文锋和 DeepSeek 的完整传奇 → [第20章·深渊剑主](../vol5-east/ch20-deepseek.md)
- 想了解姚顺雨和 Agent 研究 → [第26章·自主之兽](../vol6-convergence/ch26-agents.md)
